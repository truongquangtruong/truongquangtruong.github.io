  ...
  <section class="profile-hero">
    ...
    <div class="profile-info">
      ...
      <div class="cv-button-container">
        <a href="{{ '/assets/CV cá nhân.pdf' | relative_url }}" target="_blank" class="btn-cv btn-cv-primary">
          <span>👁️</span> Xem CV Online
        </a>
        <a href="{{ '/assets/CV cá nhân.pdf' | relative_url }}" download class="btn-cv btn-cv-outline">
