...
<div style="text-align: center; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
  <div style="margin-bottom: 25px;">
    <img src="{{ '/assets/me.png' | relative_url }}" alt="Trương Quang Trường" style="width: 100%; max-width: 380px; height: auto; border-radius: 12px; border: 4px solid #007bff; box-shadow: 0 8px 16px rgba(0,0,0,0.15);">
  </div>
